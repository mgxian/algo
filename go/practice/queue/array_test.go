...
var _ = Describe("Array", func() {
	Describe("create a array queue", func() {
		Context("when queue size is zero", func() {
			queue := NewArrayQueue(0)
	...
	Describe("enqueue a element to array queue", func() {
	...
	Describe("dequeue a element from array queue", func() {
		Context("when queue size is one", func() {
			queue := NewArrayQueue(1)
			queue.Enqueue(1)
			It("should return right elements", func() {
	...
	Describe("peek a element from array queue", func() {
		Context("when queue size is one", func() {
			queue := NewArrayQueue(1)
	...
	Describe("check if array queue is empty", func() {
		Context("when queue size is one", func() {
			queue := NewArrayQueue(1)
	...
	Describe("check if array queue is full", func() {
		Context("when queue size is one", func() {
			queue := NewArrayQueue(1)
